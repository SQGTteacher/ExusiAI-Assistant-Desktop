...
public sealed class PageFactory(ExtensionRuntime runtime, WpfNavigationRegistry registry, IThemeService theme, IWindowBackdropService backdrop, ISettingsService settings, IPackageCatalog catalog, ILoggerFactory loggerFactory)
{
