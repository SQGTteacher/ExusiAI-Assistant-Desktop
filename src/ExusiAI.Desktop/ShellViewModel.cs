...
public sealed partial class ShellViewModel : ObservableObject
{
    ...
    public ShellViewModel(PageFactory pageFactory)
    {
        ...
        NavigationItems = new([
            new("home", "首页", "M3,3 H9 V9 H3 Z M15,3 H21 V9 H15 Z M3,15 H9 V21 H3 Z M15,15 H21 V21 H15 Z"),
            new("workspace", "插件工作台", "M4,5 H20 V19 H4 Z M4,9 H20 M9,9 V19"),
            new("marketplace", "资源库", "M4,7 H20 V20 H4 Z M8,7 V5 A4,4 0 0 1 16,5 V7 M8,12 H16"),
            new("extensions", "扩展管理", "M12,3 A3,3 0 1 1 12,9 A3,3 0 1 1 12,3 M5,13 H19 V21 H5 Z"),
            new("theme", "主题", "M12,3 A9,9 0 1 0 12,21 C14,21 15,20 15,18 C15,16 13,16 13,14 C13,12 15,11 17,11 H21"),
